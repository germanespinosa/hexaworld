...
struct Action_planner : Planner {
    Action_planner( cell_world::World &, const cell_world::Cell &, const cell_world::Cell &, double, Reward_config, uint32_t);
    Action_planner( cell_world::World &, const cell_world::Cell &, const cell_world::Cell &, uint32_t, Reward_config, uint32_t);
    void plan() override ;

...
struct Action_set{
    Action_set(cell_world::Cell_group &,cell_world::Connection_pattern, cell_world::Chance &);
...
private:
    ...
    void _add_action(cell_world::Location, cell_world::Cell_group &,  cell_world::Chance &);
};
